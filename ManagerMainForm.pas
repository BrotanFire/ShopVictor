...
ADOStoredProc1.ExecProc; // Выполняем процедуру
FormShow(Sender);
end;
...
DBGRID1.Columns[3].Title.caption :='Дата';
DBGRID1.Columns[4].Width:=370;
DBGRID1.Columns[4].Title.caption :='Адрес';
DBGRID1.Columns[5].Width:=150;
DBGRID1.Columns[5].Title.caption :='Статус';
...
DBGRID2.Columns[2].Title.caption :='Описание';
DBGRID2.Columns[3].Width:=200;
DBGRID2.Columns[3].Title.caption :='Тип';
...
DBGRID2.Columns[7].Title.caption :='Скидка';
DBGRID2.Columns[8].Width:=300;
DBGRID2.Columns[8].Title.caption :='Количество на складе';
